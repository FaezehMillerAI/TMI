...
- `rjp_method/evaluate.py`: BLEU-1, BLEU-4, ROUGE-L, CIDEr (official if available, otherwise proxy), consistency/fidelity/usefulness
- `rjp_method/explainability.py`: **novel explainability module beyond heatmaps**
...
```bash
python run_paper1.py --data_root /root/.cache/kagglehub/datasets/raddar/chest-xrays-indiana-university/versions/2 --run_name no_counterfactual_seed42 --disable_counterfactual --seed 42
```
...
These provide good/bad cases and differential reasoning analysis for paper figures.
